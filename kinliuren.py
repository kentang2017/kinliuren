...
#日貴人 甲羊戊庚牛。乙猴己鼠求。丙雞丁豬位。壬癸兔蛇游。六辛逢虎上。陽貴日中 。
#夜貴人 甲牛戊庚羊乙鼠鄉。丙豬丁雞上。壬蛇癸兔藏。六辛逢午馬。陰貴夜時當。
...
def biyung(jieqi, daygangzhi, hourgangzhi):
    ...
    if filter_list[0] == "試賊尅":
        ...
        if filter_list_yy[0] == dayganzhi_yy:
            ...
            findtrue = ["比用", "比用", find_three_pass(jieqi, hourgangzhi,filter_list[2][filter_list[4].index("True")][0])]
        return findtrue
