...
class Liuren():
    def __init__(self, jieqi, daygangzhi, hourgangzhi):
        ...
        #生尅六親
        self.liuqing_dict = dict(zip("被生,生,尅,比和,被尅".split(","),re.findall("..", "父母子孫妻財兄弟官鬼")))
    ...
    def result_month(self, num):
        ...
        return {"節氣":self.jieqi, "日期":self.daygangzhi+"月"+self.hourgangzhi+"日", "格局":ju, "日馬": dyima, "三傳":three_pass, "四課":sike, "天地盤":sky_earth_guiren_dict, "地轉天盤":sky_earth, "地轉天將": earth_to_general, "廿八宿":starpan}
...
if __name__ == '__main__':
    ...
    print(Liuren("立秋","戊子","癸亥").result(0))
