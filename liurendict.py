...
#甲戊庚牛羊，乙己鼠猴鄉，丙丁豬雞位，壬癸兔蛇藏，六辛逢馬虎，此是貴人強。
...
guiren_dict2 = { tuple(list("甲戊庚")):{"晝":"丑", "夜":"未"}, tuple(list("乙己")):{"晝":"子", "夜":"申"}, tuple(list("丙丁")):{"晝":"亥", "夜":"酉"}, tuple(list("壬癸")):{"晝":"卯", "夜":"巳"}, "辛":{"晝":"午", "夜":"寅"}}

#天將
sky_generals_rev  = "貴蛇雀合勾龍空虎常玄陰后"
sky_generals ="貴后陰玄常虎空龍勾合雀蛇"
