...
with pan:
    ...
    with st_capture(output2.code):
        ...
        print("　　{}{}　　{}{}".format(ltext.get("地轉天將").get("辰"), ltext.get("地轉天盤").get("辰"), ltext.get("地轉天盤").get("申"), ltext.get("地轉天將").get("申")))
        print("　　{}{}　　{}{}".format(ltext.get("地轉天將").get("卯"), ltext.get("地轉天盤").get("卯"), ltext.get("地轉天盤").get("酉"), ltext.get("地轉天將").get("酉")))
