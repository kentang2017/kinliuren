...
class Liuren():
    ...
    def zeike(self):
        ...
        #一個下賊上
            ...
            findtrue =  ["返吟", "自任", [self.shigangjigong.get(self.daygangzhi[0]), self.ying.get(self.shigangjigong.get(self.daygangzhi[1])), self.chong2.get(self.ying.get(self.shigangjigong.get(self.daygangzhi[1])))]]
            return findtrue
